...
// IS JASMINE EVEN WORKING?!
  it("should foo", function() {
    ...
    updated_items = update_quality();
    expect(updated_items[0].name).toEqual("foo");
  });
});
...
// Sell_in
  it("should decrease sell_in by 1", function() {
    ...
    updated_items = update_quality();
    expect(updated_items[0].sell_in).toEqual(0);
  });
...
// Quality
  it("should decrease quality by 1", function() {
    items = [ new Item("foo", 1, 1) ];
    updated_items = update_quality();
    expect(updated_items[0].quality).toEqual(0);
  });
...
// Sell_in
  it("should not change sell_in", function() {
    ...
    updated_items = update_quality();
    expect(updated_items[0].sell_in).toEqual(1);
  });
...
// Quality
  it("should not change quality", function() {
    items = [ new Item("Sulfuras, Hand of Ragnaros", 1, 49) ];
    updated_items = update_quality();
    expect(updated_items[0].quality).toEqual(49);
  });
});
...
// Sell_in
  it("should decrease sell_in by 1", function() {
    ...
    updated_items = update_quality();
    expect(updated_items[0].sell_in).toEqual(4);
  });
...
// Quality
  ...
  it("should increase quality by 2 when sell_in is lesser than 11 and greater than 5", function() {
    ...
    updated_items = update_quality();
    expect(updated_items[0].quality).toEqual(48);
  });
